...
function renderOpen(){
 ...
 $('openPage').innerHTML=`
  ...
  <div class="kpis">
   ...
   <div class="kpi"><div class="kpi-label">قدیمی‌ترین لید</div><div class="kpi-value">${fa(k.oldest)}</div><div class="kpi-sub">روز از تاریخ ثبت</div></div>
  ...
  <div class="panel open-status-chart" style="margin-bottom:18px"><div class="panel-head"><div><h3>توزیع آخرین وضعیت سرنخ‌های باز</h3><div class="section-note">نمودار با فیلترهای بالای صفحه همگام است؛ برای مشاهده جزئیات روی هر وضعیت کلیک کنید.</div></div><span class="badge">${fa((d.lastStatus||[]).reduce((a,x)=>a+Number(x[1]||0),0))} لید</span></div><div id="openStatusDonut">${donut(d.lastStatus)}</div></div>
 ...
 bindDonut($('openStatusDonut'),v=>loadOpenDetail('lastStatus',v));
