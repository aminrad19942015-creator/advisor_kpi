...
function activityCards(k,period){
 ...
 return `<div class="activity-kpis weekly-kpis"><div class="kpi"><div class="kpi-label">${title}</div><div class="kpi-value">${fa(k.total)}</div><div class="kpi-sub">لید صحبت‌شده + فرصت OPP + T8 + تیکت</div></div><div class="kpi"><div class="kpi-label">لید بسته‌شده</div><div class="kpi-value">${fa(k.closed)}</div><div class="kpi-sub">تعداد لیدهای بسته‌شده</div></div><div class="kpi"><div class="kpi-label">میانگین زمان بستن لید</div><div class="kpi-value">${k.closeAvg==null?'—':fa(Number(k.closeAvg).toFixed(1))}</div><div class="kpi-sub">روز؛ از تاریخ ثبت تا تاریخ آخرین تغییر</div></div><div class="kpi"><div class="kpi-label">لید صحبت‌شده</div><div class="kpi-value">${fa(k.talked)}</div><div class="kpi-sub">مبنای فعالیت</div></div><div class="kpi"><div class="kpi-label">فرصت از LEAD</div><div class="kpi-value">${fa(k.oppLead)}</div><div class="kpi-sub">صرفاً آماری</div></div><div class="kpi"><div class="kpi-label">فرصت از OPP</div><div class="kpi-value">${fa(k.opp)}</div><div class="kpi-sub">داخل فعالیت کل</div></div><div class="kpi"><div class="kpi-label">کل تماس</div><div class="kpi-value">${fa(k.calls)}</div><div class="kpi-sub">${fa(k.uniqueCalls)} لید یکتا / ${fa(k.repeatCalls)} تماس اضافه</div></div><div class="kpi"><div class="kpi-label">تماس ورودی T8</div><div class="kpi-value">${fa(k.t8)}</div><div class="kpi-sub">زیرمجموعه تماس‌ها</div></div><div class="kpi"><div class="kpi-label">تیکت</div><div class="kpi-value">${fa(k.tickets)}</div><div class="kpi-sub">رسیدگی‌شده</div></div>${period==='daily'?'':`<div class="kpi accent-kpi"><div class="kpi-label">سرانه تماس روزانه واحد</div><div class="kpi-value">${fa(Number(k.callAvg||0).toFixed(2))}</div></div><div class="kpi accent-kpi"><div class="kpi-label">سرانه لید بسته در روز</div><div class="kpi-value">${fa(Number(k.closedAvg||0).toFixed(2))}</div></div><div class="kpi accent-kpi"><div class="kpi-label">سرانه لید صحبت‌شده در روز</div><div class="kpi-value">${fa(Number(k.talkedAvg||0).toFixed(2))}</div></div>`}</div>`;
}
